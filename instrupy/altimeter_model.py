...
class AltimeterSensorModel(BasicSensorModel):
    def __init__(self, name=None, mass=None, volume=None, power=None,  orientation=None,
                 ...
                 numberDetectorRows=None, numberDetectorCols=None, chirpBandwidth=None, pulseWidth=None, _id=None):
    ...
    def from_dict(d):
        ...
        return AltimeterSensorModel(
                ...
                chirpBandwidth = d.get("chirpBandwidth", 4),
                pulseWidth = d.get("pulseWidth", 4),
